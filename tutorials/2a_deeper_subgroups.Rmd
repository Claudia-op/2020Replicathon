...
Something that was not considered in Haibe-Kains et al. (2013) was that different cell lines may be more or less **resistant** (resistance means that the cell line does not respond to treatment by a drug) to drug treatment than others. Let's explore first why that might be an important factor, and then directly compare cell line sensitivity in the two studies. 
